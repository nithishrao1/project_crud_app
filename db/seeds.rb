...
Customer.create(name: "nithi", phone:"9983245",email:"nithi@gamil.com",address:"mysore")
Customer.create(name: "goutham", phone:"9913245",email:"gouthu@gamil.com",address:"bangalore")
Customer.create(name: "chandra", phone:"9983645",email:"chandu@gamil.com",address:"mandya")

Order.create(Order_Number: "01",Date_of_Order:"30/10/2023",Order_Status:"accepted",Billing_Address:"mysore",Shipping_Address:"mysore")
Order.create(Order_Number: "02",Date_of_Order:"25/09/2023",Order_Status:"accepted",Billing_Address:"delhi",Shipping_Address:"delhi")
Order.create(Order_Number: "02",Date_of_Order:"03/03/2023",Order_Status:"rejected",Billing_Address:"mandya",Shipping_Address:"mandya")
